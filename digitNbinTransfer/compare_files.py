...
def get_files_absent_from_destination(source_connection: Connection, destination_connection: Connection):
    ...
    for source_file, source_time in source_file_times.items():destination_connection
